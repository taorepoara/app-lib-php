...
class View
{
     ...
     * Find query for view components
     *
     * @return ViewDefinitionsFind
     */
    public function getFind() : ViewDefinitionsFind
    {
        return $this->find;
    }
    /**
     * Find query for view components
     *
     * @param ViewDefinitionsFind $find
     *
     * @return self
     */
    public function setFind(ViewDefinitionsFind $find) : self
    {
