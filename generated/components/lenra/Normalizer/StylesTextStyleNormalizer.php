...
class StylesTextStyleNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === 'Lenra\\App\\Components\\Lenra\\Model\\StylesTextStyle';
    }
    public function supportsNormalization($data, $format = null, array $context = array()) : bool
    {
        return $data instanceof \Lenra\App\Components\Lenra\Model\StylesTextStyle;
    }
    /**
     * @return mixed
     */
    public function denormalize($data, $class, $format = null, array $context = array())
    {
        ...
        $object = new \Lenra\App\Components\Lenra\Model\StylesTextStyle();
        ...
        if (\array_key_exists('shadows', $data)) {
            ...
            foreach ($data['shadows'] as $value_1) {
                $values_1[] = $this->denormalizer->denormalize($value_1, 'Lenra\\App\\Components\\Lenra\\Model\\StylesBoxShadow', 'json', $context);
            }
    ...
    {
        return array('Lenra\\App\\Components\\Lenra\\Model\\StylesTextStyle' => false);
    }
}