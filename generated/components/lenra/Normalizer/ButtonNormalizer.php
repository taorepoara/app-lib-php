...
class ButtonNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === 'Lenra\\App\\Components\\Lenra\\Model\\Button';
    }
    public function supportsNormalization($data, $format = null, array $context = array()) : bool
    {
        return $data instanceof \Lenra\App\Components\Lenra\Model\Button;
    }
    /**
     * @return mixed
     */
    public function denormalize($data, $class, $format = null, array $context = array())
    {
        ...
        $object = new \Lenra\App\Components\Lenra\Model\Button();
        ...
        if (\array_key_exists('leftIcon', $data)) {
            $object->setLeftIcon($this->denormalizer->denormalize($data['leftIcon'], 'Lenra\\App\\Components\\Lenra\\Model\\Icon', 'json', $context));
        }
        if (\array_key_exists('rightIcon', $data)) {
            $object->setRightIcon($this->denormalizer->denormalize($data['rightIcon'], 'Lenra\\App\\Components\\Lenra\\Model\\Icon', 'json', $context));
        }
    ...
    {
        return array('Lenra\\App\\Components\\Lenra\\Model\\Button' => false);
    }
}