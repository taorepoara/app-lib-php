...
class ComponentsTextNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === 'Lenra\\App\\Response\\View\\Model\\ComponentsText';
    }
    public function supportsNormalization($data, $format = null, array $context = array()) : bool
    {
        return $data instanceof \Lenra\App\Response\View\Model\ComponentsText;
    }
    /**
     * @return mixed
     */
    public function denormalize($data, $class, $format = null, array $context = array())
    {
        ...
        $object = new \Lenra\App\Response\View\Model\ComponentsText();
        ...
        if (\array_key_exists('style', $data)) {
            $object->setStyle($this->denormalizer->denormalize($data['style'], 'Lenra\\App\\Response\\View\\Model\\ComponentsStylesTextStyle', 'json', $context));
        }
        if (\array_key_exists('locale', $data)) {
            $object->setLocale($this->denormalizer->denormalize($data['locale'], 'Lenra\\App\\Response\\View\\Model\\ComponentsStylesLocale', 'json', $context));
        }
        ...
        if (\array_key_exists('children', $data)) {
            ...
            foreach ($data['children'] as $value) {
                $values[] = $this->denormalizer->denormalize($value, 'Lenra\\App\\Response\\View\\Model\\ComponentsText', 'json', $context);
            }
    ...
    {
        return array('Lenra\\App\\Response\\View\\Model\\ComponentsText' => false);
    }
}