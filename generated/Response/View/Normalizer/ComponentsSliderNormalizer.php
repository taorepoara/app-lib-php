...
class ComponentsSliderNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === 'Lenra\\App\\Response\\View\\Model\\ComponentsSlider';
    }
    public function supportsNormalization($data, $format = null, array $context = array()) : bool
    {
        return $data instanceof \Lenra\App\Response\View\Model\ComponentsSlider;
    }
    /**
     * @return mixed
     */
    public function denormalize($data, $class, $format = null, array $context = array())
    {
        ...
        $object = new \Lenra\App\Response\View\Model\ComponentsSlider();
        ...
        if (\array_key_exists('style', $data)) {
            $object->setStyle($this->denormalizer->denormalize($data['style'], 'Lenra\\App\\Response\\View\\Model\\ComponentsStylesSliderStyle', 'json', $context));
        }
        ...
        if (\array_key_exists('onChangeEnd', $data)) {
            $object->setOnChangeEnd($this->denormalizer->denormalize($data['onChangeEnd'], 'Lenra\\App\\Response\\View\\Model\\ComponentsListener', 'json', $context));
        }
        if (\array_key_exists('onChangeStart', $data)) {
            $object->setOnChangeStart($this->denormalizer->denormalize($data['onChangeStart'], 'Lenra\\App\\Response\\View\\Model\\ComponentsListener', 'json', $context));
        }
    ...
    {
        return array('Lenra\\App\\Response\\View\\Model\\ComponentsSlider' => false);
    }
}