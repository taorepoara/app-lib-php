...
class ComponentsStylesBoxShadowNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === 'Lenra\\App\\Response\\View\\Model\\ComponentsStylesBoxShadow';
    }
    public function supportsNormalization($data, $format = null, array $context = array()) : bool
    {
        return $data instanceof \Lenra\App\Response\View\Model\ComponentsStylesBoxShadow;
    }
    /**
     * @return mixed
     */
    public function denormalize($data, $class, $format = null, array $context = array())
    {
        ...
        $object = new \Lenra\App\Response\View\Model\ComponentsStylesBoxShadow();
        ...
        if (\array_key_exists('offset', $data)) {
            $object->setOffset($this->denormalizer->denormalize($data['offset'], 'Lenra\\App\\Response\\View\\Model\\ComponentsStylesOffset', 'json', $context));
        }
        return $object;
    }
    /**
    ...
    {
        return array('Lenra\\App\\Response\\View\\Model\\ComponentsStylesBoxShadow' => false);
    }
}