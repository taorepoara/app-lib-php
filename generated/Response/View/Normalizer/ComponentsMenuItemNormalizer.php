...
class ComponentsMenuItemNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === 'Lenra\\App\\Response\\View\\Model\\ComponentsMenuItem';
    }
    public function supportsNormalization($data, $format = null, array $context = array()) : bool
    {
        return $data instanceof \Lenra\App\Response\View\Model\ComponentsMenuItem;
    }
    /**
     * @return mixed
     */
    public function denormalize($data, $class, $format = null, array $context = array())
    {
        ...
        $object = new \Lenra\App\Response\View\Model\ComponentsMenuItem();
        ...
        if (\array_key_exists('icon', $data)) {
            $object->setIcon($this->denormalizer->denormalize($data['icon'], 'Lenra\\App\\Response\\View\\Model\\ComponentsIcon', 'json', $context));
        }
    ...
    {
        return array('Lenra\\App\\Response\\View\\Model\\ComponentsMenuItem' => false);
    }
}