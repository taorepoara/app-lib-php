...
class ComponentsStylesCarouselOptionsNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === 'Lenra\\App\\Response\\View\\Model\\ComponentsStylesCarouselOptions';
    }
    public function supportsNormalization($data, $format = null, array $context = array()) : bool
    {
        return $data instanceof \Lenra\App\Response\View\Model\ComponentsStylesCarouselOptions;
    }
    /**
     * @return mixed
     */
    public function denormalize($data, $class, $format = null, array $context = array())
    {
        ...
        $object = new \Lenra\App\Response\View\Model\ComponentsStylesCarouselOptions();
        ...
        if (\array_key_exists('autoPlayInterval', $data)) {
            $object->setAutoPlayInterval($this->denormalizer->denormalize($data['autoPlayInterval'], 'Lenra\\App\\Response\\View\\Model\\ComponentsStylesDuration', 'json', $context));
        }
        if (\array_key_exists('autoPlayAnimationDuration', $data)) {
            $object->setAutoPlayAnimationDuration($this->denormalizer->denormalize($data['autoPlayAnimationDuration'], 'Lenra\\App\\Response\\View\\Model\\ComponentsStylesDuration', 'json', $context));
        }
    ...
    {
        return array('Lenra\\App\\Response\\View\\Model\\ComponentsStylesCarouselOptions' => false);
    }
}