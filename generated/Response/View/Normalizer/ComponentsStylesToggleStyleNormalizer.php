...
class ComponentsStylesToggleStyleNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === 'Lenra\\App\\Response\\View\\Model\\ComponentsStylesToggleStyle';
    }
    public function supportsNormalization($data, $format = null, array $context = array()) : bool
    {
        return $data instanceof \Lenra\App\Response\View\Model\ComponentsStylesToggleStyle;
    }
    /**
     * @return mixed
     */
    public function denormalize($data, $class, $format = null, array $context = array())
    {
        ...
        $object = new \Lenra\App\Response\View\Model\ComponentsStylesToggleStyle();
        ...
        if (\array_key_exists('activeThumbImage', $data)) {
            $object->setActiveThumbImage($this->denormalizer->denormalize($data['activeThumbImage'], 'Lenra\\App\\Response\\View\\Model\\ComponentsImage', 'json', $context));
        }
        if (\array_key_exists('inactiveThumbImage', $data)) {
            $object->setInactiveThumbImage($this->denormalizer->denormalize($data['inactiveThumbImage'], 'Lenra\\App\\Response\\View\\Model\\ComponentsImage', 'json', $context));
        }
    ...
    {
        return array('Lenra\\App\\Response\\View\\Model\\ComponentsStylesToggleStyle' => false);
    }
}