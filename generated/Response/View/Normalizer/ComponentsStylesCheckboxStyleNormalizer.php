...
class ComponentsStylesCheckboxStyleNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === 'Lenra\\App\\Response\\View\\Model\\ComponentsStylesCheckboxStyle';
    }
    public function supportsNormalization($data, $format = null, array $context = array()) : bool
    {
        return $data instanceof \Lenra\App\Response\View\Model\ComponentsStylesCheckboxStyle;
    }
    /**
     * @return mixed
     */
    public function denormalize($data, $class, $format = null, array $context = array())
    {
        ...
        $object = new \Lenra\App\Response\View\Model\ComponentsStylesCheckboxStyle();
        ...
        if (\array_key_exists('shape', $data)) {
            $object->setShape($this->denormalizer->denormalize($data['shape'], 'Lenra\\App\\Response\\View\\Model\\ComponentsStylesOutlinedBorder', 'json', $context));
        }
    ...
    {
        return array('Lenra\\App\\Response\\View\\Model\\ComponentsStylesCheckboxStyle' => false);
    }
}