...
class TypeParser
{
  ...
  {
    echo "Generating " . $this->baseClassFile . " file for " . $this->className . "\n";
    ...
    $componentType = isset($this->type) ? "'" . $this->type . "'" : '';
    $code .= "  public function __construct(" . join(" ,", array_map(function ($arg) {
      return $arg->arg();
    }, $this->constructArgs)) . ")\n  {\n";
    $code .= "    parent::__construct(" . $componentType . ");\n";
    ...
    foreach ($this->properties as $prop) {
      ...
      $code .= "    \$this->data['" . $prop->key . "'] = " . $prop->var . ";\n";
      $code .= "    return \$this;\n";
      $code .= "  }\n\n";
    }
